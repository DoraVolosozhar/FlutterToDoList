...
class DBProvider {
  ...
  Future<List<Map<String, dynamic>>> query(String table,
      {List<String>? columns, String? where, List<dynamic>? whereArgs, String? orderBy}) async {
  ...
  Future<List<Map<String, dynamic>>> rawQuery(String sql, List<dynamic> arguments) async {
    final db = await DBProvider.database;
    List<Map<String, dynamic>> rows = await db.rawQuery(sql, arguments);
    return Future.value(rows);
  }
  ...
  Future<int> update(String table, Map<String, dynamic> values, String where, List<dynamic> whereArgs ) async {
    final db = await DBProvider.database;
    int count = await db.update(table, values, where: where, whereArgs: whereArgs);
  ...
  Future<int> delete(String table, String where, List<dynamic> whereArgs) async {
    ...
    int row = await db.delete(table, where: where, whereArgs: whereArgs);
